...
router.get('/sellers/:id', async (req, res) => {
  ...
  try {
    ...
    const formattedSeller = {
      ...
      profilePhoto: seller.profile_photo ? (seller.profile_photo.startsWith('http') ? seller.profile_photo : `${req.protocol}://${req.get('host')}${seller.profile_photo}`) : null,
      coverPhoto: seller.cover_photo ? (seller.cover_photo.startsWith('http') ? seller.cover_photo : `${req.protocol}://${req.get('host')}${seller.cover_photo}`) : null,
